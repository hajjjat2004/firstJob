...
function App(props) {
  ...
  // useEffect(() => {
  //   axios.get('http://localhost:3010/delete')
  // }, [])
  const first = useRef();
  const sec = useRef();
  ...
  const btHandler = async (e) => {
    ...
    let obj = {
      ...
      // header1: et.header1.value-1,// name of the header
      ...
      // header2: et.header2.value-1,// name of the header
          ...
          <div className='containar-one'>
            ...
            <div className='formdroplist'>
              {firstBtn && <>
                ...
                <select name="header1" id="header1" defaultValue={file1Data.arr.length > 1 ? 2 : 4}>
